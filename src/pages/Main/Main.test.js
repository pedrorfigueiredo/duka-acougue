...
describe("Main", () => {
  ...
  it('should render an ItemGrid when fetching succeed', () => {
    ...
    expect(wrapper.containsMatchingElement(<ItemGrid items={items} />)).toBe(true);
  });
  ...
  it('should render an Error when fetching fails', () => {
    ...
    expect(wrapper.containsMatchingElement(<Error>Erro no servidor. Tente novamente.</Error>)).toBe(true);
  });
